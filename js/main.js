...
(() => {
	...
	let profileButtons = document.querySelectorAll('.profiles div'),
		...
		description = ['Spencer Mellor, also known as the CEO and founder of Dynamic. Spencer is currently a full time student at Fanshawe College in the Interactive Media Design program which teaches you to build interative websites just like this! He also enjoys long walks on the beach, horse back rides, and sunsets! What a hunk!','jordans info','tessas info']
